defmodule NeedForSpeed do
  ...
  alias NeedForSpeed.Race, as: Race, only: [display_status: 1, display_distance: 1]
  alias NeedForSpeed.RemoteControlCar, as: Car, only: [display_distance: 1, display_battery: 1]
  import IO
