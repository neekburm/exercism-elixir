defmodule GottaSnatchEmAll do
  ...
  def add_card(card, collection) do
    ...
    collection_already_contains_card = MapSet.equal?(collection, updated_collection)
  ...
  def split_shiny_cards(collection) do
    {shiny, boring} = Enum.split_with(collection, fn card -> String.contains?(card, "Shiny") end)
