defmodule PigLatin do
  ...
  def shift_consonants(word) do
    chars = String.to_charlist(word)
    split_index = Enum.find_index(chars, fn c -> vowel?(c) end)
